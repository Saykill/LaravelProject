            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="{{asset('assets')}}/shop.html" class="nav-item nav-link">Shop</a>
                        <a href="{{asset('assets')}}/cart.html" class="nav-item nav-link">Shop Cart</a>
                        <a href="{{asset('assets')}}/checkout.html" class="nav-item nav-link">Checkout</a>
